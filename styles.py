...
def load_css():
    st.markdown("""
        ...
        <style>
            /* [STYLE-02] GLOBAL THEME */
            :root {
                --bg-dark: #0e0e0e; /* Derin Siyah */
                --sidebar-bg: #050505; /* Simsiyah Sidebar */
                --gold: #D4AF37;
                --text-gray: #888;
            ...
            /* [STYLE-03] COMMAND CENTER SIDEBAR (ÖZEL TASARIM) */
            ...
            .status-dot {
                ...
                box-shadow: 0 0 10px #00ff88; margin-right: 8px;
            }
